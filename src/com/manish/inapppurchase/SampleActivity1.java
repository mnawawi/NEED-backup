...
public class SampleActivity1 extends Activity {
    ...
    // note that these credentials will differ between live & sandbox environments.AcPsjhDaQRJYmUtE9ERifh86ZUD0poK_l4P5BaeH3tTD7gHSGUZHguARvBie
    private static final String CONFIG_CLIENT_ID = "AYn5OhBZxPP7kwijq3Snn2Z-tJjc3S1nRCiFDdCDa9SftAc4hHZJkAF7ND3H";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clikbutton1 = MediaPlayer.create(SampleActivity1.this, R.raw.click1);
    ...
    public void onBuyPressed(View pressed) {
        ...
        Intent intent = new Intent(SampleActivity1.this, PaymentActivity.class);
    ...
    private PayPalPayment getThingToBuy(String environment) {
        return new PayPalPayment(new BigDecimal("3.00"), "MYR", "N.E.E.D DONATION",
                environment);
    }
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(SampleActivity1.this, PayPalFuturePaymentActivity.class);
